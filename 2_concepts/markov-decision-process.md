...
- A __Markov Decision Process (MDP)__ extends a [Markov Reward Process](2_concepts/markov-reward-process.md), with actions that influence the state transition
