...
---
> [!info] Background
> - In [RL](REINFORCEMENT-LEARNING.md), our goal is to take actions which maximize our rewards, given a [Markov decision process](2_concepts/markov%20decision%20process.md)
...
>     - the types of algorithms that use it are often called [monte carlo policy evaluation](2_concepts/monte%20carlo%20policy%20evaluation.md)
> - Instead, we often use an estimate of the __expected__ future rewards __starting a specific state__ and following a __specific policy__ aka the [value function](2_concepts/value%20functions.md)
