...
$$
- additionally, we re-express the [cross product](2_concepts/cross%20product.md) $\mathbf{t} \times \mathbf{x}_r$ as a matrix multiplication of the skew-symmetric matrix, $[\mathbf{t}]_\times$:
$$
