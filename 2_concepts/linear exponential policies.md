...
- An extension of the [gradient bandit algorithm](2_concepts/gradient%20bandit%20algorithm.md), that uses the __preference__, $h$ but now adds state and action: $h(s,a)$
- Although $h$ now resembles a [state-action value function](2_concepts/value%20functions.md), it differs since:
