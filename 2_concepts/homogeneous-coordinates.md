...
- Homogeneous coordinates augment the Cartesian coordinates by adding an extra coordinate, allowing transformations like translation to be represented as matrix multiplications (via an [affine-transform](2_concepts/affine-transform.md))
