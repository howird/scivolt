...
- defined as the difference between the [state-action value function](2_concepts/value-functions.md) $Q_\pi(s, a)$ and the [state value function](2_concepts/value-functions.md) $V_\pi(s)$:
$$
...
- [TD Learning](2_concepts/temporal-difference-policy-evaluation.md) concepts such as TD Target and TD Error ($\delta_t$) are related to how well we estimate future rewards
