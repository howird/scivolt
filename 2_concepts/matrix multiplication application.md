...
- Now that we have discussed the 3 types of parallelism:
  ...
  - [Instruction Level Parallel](2_concepts/instruction%20level%20parallelism.md) (datapath parallelism)
  - [Data Level Parallelism](2_concepts/data%20level%20parallelism.md) (loop parallelism)
  - [Transaction Level Parallelism](2_concepts/transaction%20level%20parallelism.md) (dataflow parallelism)
