...
Soft K-Means Clustering is an extension of [K-Means Clustering](2_concepts/k%20means.md)
...
This algorithm follows the same setup as that of [K-Means Clustering](2_concepts/k%20means.md)
