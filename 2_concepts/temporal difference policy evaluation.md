...
> [!info] Background
> - from [MC Policy Evaluation](2_concepts/monte%20carlo%20policy%20evaluation.md), we have the algorithm:
>     - Initialization
...
- TD learning is a [model free](2_concepts/model%20free.md) method for **policy evaluation** that combines ideas from **Monte Carlo** methods and **dynamic programming**
...
- Monte Carlo in batch settings converges to minimizing [MSE](2_concepts/mean%20squared%20error.md)
