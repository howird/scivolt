...
- In [epipolar geometry](2_concepts/epipolar%20geometry.md), which is fundamental in stereo vision and 3D reconstruction, the cross product is used to compute the epipolar lines
