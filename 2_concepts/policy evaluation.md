...
- A [Markov Decision Process](2_concepts/markov%20decision%20process.md): $MDP(S, A, P, R, \gamma)$, can actually be re-framed as a [Markov Reward Process](2_concepts/markov%20reward%20process.md): $MRP(S, P, R, \gamma)$, by defining 
