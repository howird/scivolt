...
- [Epipolar Geometry](2_concepts/epipolar-geometry.md): Describes the intrinsic projective geometry between two views.
- Essential Matrix $E$: Encapsulates rotation and translation between two calibrated cameras.
- [Fundamental Matrix](2_concepts/fundamental-matrix.md) $F$: Extends $E$ to uncalibrated cameras, incorporating intrinsic parameters.
