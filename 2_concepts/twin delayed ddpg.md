...
- In [DQN](2_concepts/deep%20q%20networks.md), two sets of parameters are used for the Deep Q Network, giving a "Prediction Network" and a "Target Network" to avoid __maximization bias__
...
- This method was called Double DQN, not to be confused with [Double Q-learning](2_concepts/double%20q%20learning.md)
...
- In original [Double Q-learning](2_concepts/double%20q%20learning.md), the two Q functions are used to update each other in their TD error updates, here, we further avoid overestimation bias by taking the $\min$ between both estimates
