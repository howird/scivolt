...
- __What does E2E learning mean for sequential decision making?__
- In terms of [reinforcement learning](3_areas/REINFORCEMENT-LEARNING.md), traditionally, before end to end learning would handle the recognition component and the control components separately
...
- RL problem represents the entirety the AI problem, supervised learning relies on inputs and labels while RL aim for optimal behavior without input/output, simply rely on reward feedback
