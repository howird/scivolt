...
- A variant of [Q-Learning](2_concepts/q%20learning.md) designed to mitigate the overestimation bias in Q-learning by decoupling action selection from action evaluation.
