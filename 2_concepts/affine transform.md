...
- Affine transformations are linear transformations performed upon [homogeneous coordinates](2_concepts/homogeneous%20coordinates.md)
...
$$
- Where:
    - matrix $A \in \mathbb{R}^{n \times n}$ represents the linear transformation [(rotation, scaling, or shearing)](2_concepts/linear%20transformations.md)
