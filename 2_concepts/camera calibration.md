...
;;
- To go from the world frame to the camera frame, only, $R|T$, a 3D [affine transform](2_concepts/affine%20transform.md) is needed (consisting of a rotation and a translation)
